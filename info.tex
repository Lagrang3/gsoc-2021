...
participate once in a while on \url{codeforces.com} rounds.
...
this year's \gsoc. The time frame provided by the event is not sufficient to
cover all the relevant aspects of fully grown \fft\ library.
Hence I will continue working on it after this year's \gsoc\ in order to improve
the performance and user interface, as well as bug-fixes and the implementation
of multi-threading features. Future major improvement will include distributed
memory \fft\ based on \boostmpi.
