...
\section{Timeline}
    ...
    Start working on a back-end for \fftw\, with support for simple
    functionality: complex to complex transforms with single and double precision. 
    ...
    Prepare a set of benchmarks to test the performance of different back-ends.
    
    \subsection*{June 21 -- June 27}
    Implement convolution routines and tests.
    ...
    Test the \api\ with other back-ends, for instance
